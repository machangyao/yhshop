                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        @if (count($errors) > 0)
                         ...
                         @endif
                        <form class="form-horizontal" action="{{ url('/admin/permission') }}" method="post" enctype="multipart/form-data">
                        	{{ csrf_field() }}
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="description" type="textd" class="form-control" id="inputPassword3">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
