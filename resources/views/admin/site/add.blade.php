            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-warning">
                        ...
                        <form role="form" action="{{ url('/admin/site/doadd') }}" method="post" id="form_upload"  enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                <div class="col-sm-5">
                                    <label>网站关键字</label>
                                    <input type="text" class="form-control" name="site_keyword" value="">
                                </div>
                            </div>
                            ...
                            <div class="box-body">
                                <div class="col-sm-5">
                                    ...
                                    <textarea class="form-control" rows="3" name="site_describe" ></textarea>
                            ...
                            <div class="box-body">
                                <div class="col-sm-5">
                                    <label>网站版权声明</label>
                                    <input type="text" class="form-control" name="site_copyright" value="">
                                </div>
                            </div>
