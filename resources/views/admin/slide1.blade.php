...
<div class="box">
    <div class="box-header">
                            <h3 class="box-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">轮播图</font></font></h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info"> 
								...
								@foreach($slide as $v)
                                    ...
                                    <td><font style="vertical-align: inherit;"><a href="  ">编辑</a> | <a href="  ">删除</a></font></td>
