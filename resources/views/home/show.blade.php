...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link type="text/css" href="{{ asset('/yh/home/css/optstyle.css') }}" rel="stylesheet" />
		<link type="text/css" href="{{ asset('/yh/home/css/style.css') }}" rel="stylesheet" />
		...
		<script type="text/javascript" src="{{ asset('/yh/home/AmazeUI-2.4.2/assets/js/amazeui.js') }}"></script>
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="/yh/home/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="/yh/home/images/02.jpg" />
								</li>
								<li>
									<img src="/yh/home/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												...
												<div class="theme-signin-right">
													<div class="img-info">
														<img src="/yh/home/images/songzi.jpg" />
													</div>
													<div class="text-info">
						...
						<div class="pay">
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="addcart" title="加入购物车" href="javascript:;"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
				...
				<div class="match">
					...
					<div class="match-comment">
						<ul class="like_list">
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="/yh/home/images/cp.jpg"></a>
							...
							<li>
								<div class="s_picBox">
									<a class="s_pic" href="#"><img src="/yh/home/images/cp2.jpg"></a>
								...
								<div class="am-tab-panel am-fade">
									...
									<ul class="am-comments-list am-comments-list-flip">
										<li class="am-comment">
											<!-- 评论容器 -->
											<a href="">
												<img class="am-comment-avatar" src="/yh/home/images/hwbn40x40.jpg" />
												<!-- 评论者头像 -->
											</a>
